namespace StudentApp.Migrations
{
    ...
    public partial class addIdentity : DbMigration
    {
        public override void Up()
        {
            ...
            AddColumn("dbo.Students", "IdentityUserId", c => c.String(maxLength: 128));
            ...
            CreateIndex("dbo.Students", "IdentityUserId");
            ...
            AddForeignKey("dbo.Students", "IdentityUserId", "dbo.IdentityUsers", "Id");
        ...
        public override void Down()
        {
            ...
            DropForeignKey("dbo.Students", "IdentityUserId", "dbo.IdentityUsers");
            DropIndex("dbo.AspNetUsers", new[] { "Id" });
            DropIndex("dbo.AspNetUserLogins", new[] { "IdentityUser_Id" });
            DropIndex("dbo.AspNetUserClaims", new[] { "IdentityUser_Id" });
            DropIndex("dbo.IdentityUsers", "UserNameIndex");
            DropIndex("dbo.Students", new[] { "IdentityUserId" });
            ...
            DropColumn("dbo.Students", "IdentityUserId");
